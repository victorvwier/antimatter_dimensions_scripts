...
def main():
    instructions: list[Instruction] = [
        Farm(ep_target=1, path="11-61", ip_auto=10, ep_auto=1),
        Farm(ep_target=14, path=Path.TIME, ip_auto=100, ep_auto=1),
        ...
        Farm(ep_target=40, path=Path.TIME,  ip_auto=100, ep_auto=1),
        ...
        Farm(ep_target=50, ip_auto=200, path=Path.TIME, ep_auto=1),
        ...
        # Challenge(ec=4, it=4, path=str(Path.TIME) + " 181"),
        # Challenge(ec=8, it=5, path=str(Path.TIME) + " 181 193 191 212 214 211 224 232"),

        # Challenge(ec=7, it=5, path=str(Path.TIME)+" 181 193 191 212 214 211 224 232"),
        # Farm(ep_target=600, ip_auto=1000, path="11,21,22,31,32,33,41,42,51,61,62,73,83,93,103,111,121,131,141,151,161,162,171,181,191,192,193,201,72,82,92,102,214,213,212,224,232,211,222", ep_auto=15),
        # Farm(ep_target=700, ip_auto=1000, path="11,21,22,31,32,33,41,42,51,61,62,73,83,93,103,111,121,131,141,151,161,162,171,181,191,192,193,201,72,82,92,102,214,213,212,224,232,211,222", ep_auto=15),
        ...
        # Farm(ep_target=1000, ip_auto=1000, path="11,21,22,31,32,33,41,42,51,61,62,73,83,93,103,111,121,131,141,151,161,162,171,181,191,192,193,201,72,82,92,102,214,228,234,213,226,212,224,232,211,222", ep_auto=20),

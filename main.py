...
def main():
    instructions: list[Instruction] = [
        ...
        Farm(ep_target=600, ip_auto=1000, path="11-61 62 time 111 active 151-214 72-102 224 232 222", ep_auto=15), # Farm with long path
        Farm(ep_target=700, ip_auto=1000, path="11-61 62 time 111 active 151-214 72-102 224 232 222", ep_auto=15), # Farm with long path
        
        # Challenge 11
        Challenge(ec=11, it=1, path="11-61 62 antimatter 111 123 133 143 151-214 222 223 225 231 233"), # Challenge 11, iteration 1, long path
        Challenge(ec=11, it=2, path="11-61 62 antimatter 111 123 133 143 151-214 222 223 225 231 233"), # Challenge 11, iteration 2, long path
        Challenge(ec=11, it=3, path="11-61 62 antimatter 111 123 133 143 151-214 222 223 225 231 233"), # Challenge 11, iteration 3, long path
        Challenge(ec=11, it=4, path="11-61 62 antimatter 111 123 133 143 151-214 222 223 225 231 233"), # Challenge 11, iteration 4, long path
        
        # Challenge 12
        Challenge(ec=12, it=1, path="11-61 62 time 111-142 151-214 228 234 224 232 222 192"), # Challenge 12, iteration 1, long path
        Challenge(ec=12, it=2, path="11-61 62 time 111-142 151-214 228 234 224 232 222 192"), # Challenge 12, iteration 2, long path
        Challenge(ec=12, it=3, path="11-61 62 time 111-142 151-214 228 234 224 232 222 192"), # Challenge 12, iteration 3, long path
        Challenge(ec=12, it=4, path="11-61 62 time 111-142 151-214 228 234 224 232 222 192"), # Challenge 12, iteration 4, long path
        ...
        Farm(ep_target=1000, ip_auto=1000, path="11-61 62 time 111 active 151-214 72 82 92 102 dark", ep_auto=20), # Farm with very long path
        Challenge(ec=11, it=5, path="11-61 62 antimatter 123 133 143 151-214 222 223 225 231 233"), # Challenge 11, iteration 5, long path
